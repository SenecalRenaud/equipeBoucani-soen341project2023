      ...
      <Nav>
        ...
        {state.userData && state.userData.userType === "APPLICANT" && (
          <NavLink
            ...
            to={`/viewapplications/${state.userData.uid}`}
          >
            My Applications
          </NavLink>
        )}
        ...
        <NavLink to="/viewjobposts">Job Postings</NavLink>
        ...
        triggerMenuMarkup={
          <div className="loggedInUser_container">
            <div className="navbarLoggedInText">
              ...
              <p>{state.userData.userType}</p>
            </div>
            <div>
              <img
                id="navbarLoggedInPfp"
                src={state.userData.photo_url}
                width="50"
                height="50"
                alt={"pfp"}
              />
...
const Navbar = () => {
  ...
  const [toggleMenu, setToggleMenu] = useDetectOutClickOrEsc(
    minimizedMenuRef,
    false
  );
  return (
