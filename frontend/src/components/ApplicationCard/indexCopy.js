...
const ApplicationCardCopy = ({
  ...
  const [employerUid, setEmployerUid] = useState(
    "RJA0ysCVJCfd9mlFrV31zyMXftF3"
  );

  const [employerUser, setEmployerUser] = useState({
    creationEpoch: 1679976475728,
    email: "BaldandBeautiful@grumail.com",
    firstName: "Felonius",
    lastName: "Gru",
    lastSeenEpoch: 1681343764574,
    photo_url:
      "https://storage.googleapis.com/boucani-webappv2.appspot.com/profilePictures/DespicableMeGru.jpg",
    resume_url:
      "https://storage.googleapis.com/boucani-webappv2.appspot.com/resumes/GruEpicResume.pdf",
    uid: "RJA0ysCVJCfd9mlFrV31zyMXftF3",
    userType: "EMPLOYER",
  });
  ...
  return (
    <>
      <CardArticle>
        ...
        <CardDate>Date Applied: {date}</CardDate>
        <CardText></CardText>
