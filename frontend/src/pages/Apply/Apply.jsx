...
const Apply = props => {
    ...
    useEffect(() => {
        ...
        fetch("/getjob/" + state.jobPostId + "/").then(
    ...
    const submitApplication= async (event) => {
        ...
        await ApplicationAPIService.AddApplication({"jobPostId": state.jobPostId, "applicantUid": state.userContext.state.userData.uid, "coverLetter": coverLetter})
            .then((any)=> window.location.replace("http://localhost:3000/viewjobposts"))
