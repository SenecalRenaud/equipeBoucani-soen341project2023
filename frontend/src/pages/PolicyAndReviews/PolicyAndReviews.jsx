    ...
    return (
        <div className={classes.root}>
            ...
            <Typography variant="body1">
                ...
                preferences and to provide you with personalized job recommendations.
                We may also use cookies for advertising purposes.
            </Typography>
            <hr />
            <hr />
            <Typography variant="h5" className={classes.subtitle}>
            ...
            <div className={classes.caseStudy}>
                ...
                <Typography variant="body1">
                    Jane was a recent graduate looking for her first job. She signed up for
                    Boucani Job Center and started browsing job postings. She applied for
                    several jobs and was eventually offered a position at a top company.
                </Typography>
                <Typography variant="body1">
