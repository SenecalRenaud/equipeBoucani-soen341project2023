  ...
  return (
    <div className="post-comment-container">
      ...
      >
        ...
        <button
          onClick={(event) => {
            ...
            alert(
              `Your Decoded still valid idToken: ${JSON.stringify(
      ...
      <header className="Debug-header">
        ...
        <h3>
          {" "}
          Antoine C. V2 Stable <span style={{ color: "red" }}> </span>
        </h3>
      </header>
      <div
        style={{
