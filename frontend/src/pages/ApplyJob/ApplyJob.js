            ...
            <div className="apply-job-card">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="apply-job-field">
                        ...
                        <div
                            className="resume-input-wrapper"
                        >
                            <input
                                id="resume-input"
                                ...
                                required
                            />
                            <div className="resume-overlay" onClick={handleResumeOverlayClick}>
                    ...
                    <div className="additional-info-container">
                        <div className="apply-job-field">
                            <label htmlFor="additional-information-input">Additional Information</label>
